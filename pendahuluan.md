...
- **Free tier (~50 request/bulan)** biasanya **habis di pertengahan Hari 1**. Tidak direkomendasikan.
...
Detail di section "Plan & Quota Awareness" di [`instalasi-checklist.md`](./Hari-1-Fundamental-DevNotes/Sesi-02-Getting-Started-Cursor/instalasi-checklist.md).
